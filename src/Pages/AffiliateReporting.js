  ...
  <ul className="nav nav-tabs gap-2" id="myTab" role="tablist">
      ...
      <li className="nav-item" role="presentation">
        <Link to="/AffiliateReporting">
          <button className="nav-link active" id="commission-tab" data-bs-toggle="tab" data-bs-target="#commission-tab-pane" type="button" role="tab" aria-controls="commission-tab-pane" aria-selected="true">Commission Details</button>
        </Link>
      </li>
    </ul>
    <div className="tab-content" id="myTabContent">
      <div className="tab-pane fade show active py-4" id="reports-tab-pane" role="tabpanel" aria-labelledby="reports-tab" tabIndex={0}>
        <h3 className="fw-semibold mb-3">Reports</h3>
        <p>Get detailed reports on your earnings and understand what is working best for you.</p>
        <p>Track your commissions 24/7 with our online daily reports. We provide you with easy-to-read reports for your traffic, revenue, earnings, conversion rates and orders to help you monetize your website.</p>
        <h4 className="fw-semibold mb-3">Report Types</h4>
        <ul>
          <li>Referrals</li>
          <li>Orders</li>
      ...
      <div id="reportcontent-print" />
      <div className="text-end">
        <button className="btn border-0" id="download-reportContent">
...
export default AffiliateReporting
