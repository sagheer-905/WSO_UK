...
function RelatedCollection({data}) {
  ...
  return (
    <div>
      ...
      {/*------------ Related Collection Section Start -----------*/}
      <div className="latest-collection mx-3 mx-md-5 mb-5">
        <h2 className="text-uppercase text-center">Related Collection</h2>
        {/* Related collection Products slider */}
      ...
      {/*------------ Related Collection Section End ------------*/}
